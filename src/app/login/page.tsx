    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            if (result?.error) {
                ...
                // If error mentions email verification, show resend button
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-600">Sign in to continue to UniMind</p>
        </div>
        ...
        <div className="rounded-2xl bg-white p-8 shadow-xl border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-3 font-semibold text-white shadow-lg shadow-blue-500/30 transition-all hover:shadow-xl hover:shadow-blue-500/40 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
          ...
          {showResendButton && (
            <button
              ...
              disabled={isLoading}
              className="mt-4 w-full rounded-lg border-2 border-green-500 bg-green-50 px-4 py-3 font-medium text-green-700 transition-all hover:bg-green-100 disabled:opacity-50 disabled:cursor-not-allowed"
            >
